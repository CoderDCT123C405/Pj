...
public class DSKH implements iQUANLY, iTIEMNANG {
    ...
    public void docFile() {
        try {
            BufferedReader input = new BufferedReader(new FileReader("DanhSachKhachHang.txt"));
            String line;
    ...
    public void luuFile() {
        try {
            ...
            for(KHACHHANG kh : ds) {
                output.write(kh.getCccd() + "," + kh.getTen() + "," + kh.getSdt() + "," + kh.getDiaChi() + "," + kh.getNamSinh() + "," + kh.getThuong() + "," + kh.getIdkh() + "," + kh.getSL_Mua() + "," + kh.getGiamGia());
                output.newLine();
            }
        }
        catch(IOException e) {
